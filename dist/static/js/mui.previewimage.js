...
(function($, window) {
	...
	proto.init = function() {
		...
		this.more = this.element.querySelector('.mui-icon-more');
	...
	proto.initEvent = function() {
		...
		this.more.addEventListener('tap',function(){
			...
			newDiv.className = 'imgShare'
			var topDiv = document.createElement('div');
			topDiv.className = 'top'
			var bottomDiv = document.createElement('div');
			bottomDiv.className = 'bottom'
			bottomDiv.innerHTML = '取消'
			...
			var zhifubao = document.createElement('div');
			zhifubao.className = 'zhifubao'
			zhifubao.addEventListener('tap',function(){
			...
			download.addEventListener('tap',function(){
				...
				// console.log(self)
				// console.log(self.groups[0][self.lastIndex].src)
				...
				download(self.groups[0][self.lastIndex].src)
			})
			...
			topDiv.appendChild(weixin);
			topDiv.appendChild(friend);
			topDiv.appendChild(zhifubao);
			topDiv.appendChild(download);
			newDiv.appendChild(bottomDiv);
			self.element.appendChild(newDiv)
			bottomDiv.addEventListener('tap',function(){
				self.element.removeChild(newDiv)
			})
		})
	};
